...
class RegistroProductoFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        categoriaViewModel.categoriasLiveData.observe(viewLifecycleOwner) { categorias ->
            ...
            // Aquí puedes agregar el listener para obtener el ID de la categoría seleccionada
        ...
        binding.saveButton.setOnClickListener {
            if (validateFields()) {
                ...
                val productNameProvider = binding.editTextNombreProductoP.text.toString()
                val provider = binding.editTextProveedor.text.toString()
                val providerPrice =
                ...
                val nuevoProducto = Producto(
                    ...
                    nombre_producto_proveedor = productNameProvider,
                    proveedor = provider,
    ...
    private fun validateFields(): Boolean {
        ...
        binding.editTextProveedor.error = null
        ...
        if (binding.editTextProveedor.text.isNullOrBlank()) {
            binding.editTextProveedor.error = "Este campo es obligatorio"
            isValid = false
        }
