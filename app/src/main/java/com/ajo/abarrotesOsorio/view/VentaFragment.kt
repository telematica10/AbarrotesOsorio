...
import com.ajo.abarrotesOsorio.data.VentaViewModelFactory
...
class VentaFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.btnGuardarVenta.setOnClickListener {
            ...
            // Llama al método del ViewModel para guardar la venta.
            ventaViewModel.guardarVenta()
        }
    }

    /**
     * Calcula y actualiza el total de la venta en la interfaz.
     * @param lista La lista de productos en el carrito.
     */
